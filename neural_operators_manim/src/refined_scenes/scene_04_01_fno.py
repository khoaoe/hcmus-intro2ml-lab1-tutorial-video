...
class Scene0401_FNO(TimedScene):
    ...
    def construct(self):
        # ═══════════════════════════════════════════════════════════════
        # BEAT 1: [11:15–11:50] Fourier Decomposition Animation (0 to 35s)
        # ═══════════════════════════════════════════════════════════════
        ...
        # Bắt đầu với đồ thị lớn ở giữa màn hình
        axes = Axes(
        ...
        # 3 sóng harmonic riêng lẻ (cải tiến độ phân giải)
        ...
        # Labels cho các sóng (hiển thị trên đầu đồ thị)
        wave_labels = VGroup(
        ...
        # ═══════════════════════════════════════════════════════════════
        # BEAT 2: [11:50–12:30] FNO Pipeline + Convolution Theorem (35 to 75s)
        # ═══════════════════════════════════════════════════════════════
        
        # --- Pipeline: FFT → Spectral Multiply → IFFT ---
        pipeline_title = Text("FNO Layer Pipeline", font_size=24, color=NVIDIA_GREEN, 
                              weight=BOLD).to_edge(UP, buff=0.4)
        
        # Cải tiến layout pipeline
        step_data = [
        ...
        # Tạo hiệu ứng mờ dần (fading trail)
        ...
        # Global vs Local branches
        # Need to clear convolution theorem visually to make space
